    ...
    <div className="min-h-screen flex items-center justify-center bg-whiteboard p-4 transition-colors duration-300">
      <div className="max-w-md w-full glass-panel p-10 rounded-[32px] shadow-2xl">
        <div className="text-center mb-10">
          ...
          <h1 className="text-4xl font-black text-text-primary mb-3 tracking-tight">FundAI</h1>
          <p className="text-text-secondary font-medium uppercase tracking-widest text-[10px]">Secure Intelligence Access</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <label className="block text-[11px] font-bold text-text-muted uppercase tracking-widest mb-2 ml-1">Password</label>
            <div className="relative group">
          ...
          >
            {isSubmitting ? 'Authenticating...' : 'Sign In to FundAI'}
